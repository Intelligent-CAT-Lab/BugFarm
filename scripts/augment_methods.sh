...
function prompt() {
    echo;
    echo "Syntax: bash scripts/augment_methods.sh LOG_FILE_NAME NUM_WORKERS";
...
do
    python3 method_augmentor.py --project_name $project --log_file $LOG_FILE_NAME --num_workers $NUM_WORKERS;
done
