...
function prompt() {
    echo;
    echo "Syntax: bash scripts/extract_methods.sh LOG_FILE_NAME";
...
projects=("joda-time" "mockito")
for project in "${projects[@]}"
do
    python3 method_extractor.py --project_name $project --log_file $LOG_FILE_NAME;
done
